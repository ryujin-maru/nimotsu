...
<body>
    ...
    <div class="flex-flex y">
        ...
        <div class="main-right">
            <div class="top1">
                <p><i class="fa-solid fa-address-card"></i>REGISTER</p>
            </div>
                ...
                <div class="q fade del">
                    <div class="okok">
                        ...
                        <form method="POST" enctype="multipart/form-data" class="form4">
                            <p style="margin-top:20px;">id</p>
                            <input type="number" name="img_id" class="img_id"><br>
                            <input type="file" name="file"><br>
                            <input style="margin-top:20px;margin-bottom:20px;" type="submit" name="img_submit" value="送信">
                        </form>
                    </div>
                </div>
                ...
                <div class="q fade del">
                    <div class="okok">
                        ...
                        <form method="POST" class="form1">
                            <p style="margin-top:20px;">id</p>
                            <input type="number" name="delete_id" placeholder="半角数字のみ" value="<?= $s ?>"><br>
