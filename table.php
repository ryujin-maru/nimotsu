            ...
            <tbody>
                ...
                foreach($result as $row) {
                    ...
                    <tr>
                        ...
                        <td><?= $row['name']?></td>
                        <td><?= $row['number']?></td>
                        <td><div class="ko"><form method="POST"><input type="hidden" name="r[]" value="<?=$row['id']?>"><input type="hidden" name="r[]" value="<?=$row['name']?>"><input type="hidden" name="r[]" value="<?=$row['number']?>"><input type="submit" value="変更" class="up-button"></form><form method="POST"><input type="hidden" name="s" value="<?=$row['id']?>"><input type="submit" value="削除"></form></div></td>
                    </tr>
                <?php
                }
                ?>
